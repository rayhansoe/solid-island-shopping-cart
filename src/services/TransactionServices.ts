...
import { getCartItems, getCartItems$, getTotalPrice, getTotalPrice$ } from "./CartServices";
...
export const getServerTransactionsData$ = createServerData$(async () => {
	return await prisma.transaction.findMany();
});
...
export const getServerTransactionData$ = createServerData$(async (transactionId: string) => {
	return await prisma.transaction.findUnique({
		where: {
			id: transactionId,
		},
...
export const getServerTransactionItemsData$ = createServerData$(async () => {
	return await prisma.transactionItem.findMany();
});
...
export const getServerTransactionItemData$ = createServerData$(
